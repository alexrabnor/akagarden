...
const HOLES = [
  ...
  {
    n: 7, par: 4, meters: 383, index: 9,
    title: 'Det långa par-4:an',
    desc: 'Banans längsta par 4 på 383m. Index 9 placerar det mitt i svårighetsskalan — längden är utmaningen. Bra drive är ett krav för att nå greenen i två.',
    risks: ['Längd — 383m', 'Kräver bra drive', 'Svårt inspel om drive missar'],
    clubs: ['D', 'H', '56'],
    strategy: 'balanced',
    note: 'Driver + Hybrid är enda chansen att nå i två slag. Om driven missar fairway — lägg fram med 56:an och ta bunkern ur spel. Spela för par.',
  },
  {
    n: 8, par: 4, meters: 356, index: 17,
    title: 'Andningspausen',
    desc: 'Index 17 — näst lättaste hålet på banan. Medellångt par 4 på 356m. Bra tillfälle att hämta tillbaka ett slag eller sikta på birdie inför det tuffaste hålet.',
    risks: ['Falsk trygghet inför hål 9'],
    clubs: ['D', 'T9'],
    strategy: 'aggressive',
    note: 'Index 17 = ett av de lättare hålen. Driver + 9-wood ger dig goda chanser att nå i två. Satsa på par eller birdie — du behöver energin inför hål 9.',
  },
  {
    n: 9, par: 4, meters: 358, index: 1,
    title: 'Banans svåraste',
    desc: 'Index 1 — banans allra svåraste hål avslutar första nio. Lång par 4 på 358m med hinder och krav på precision. Tålamod och respekt krävs.',
    risks: ['Index 1', 'Hinder längs banan', 'Greenkomplex', 'Mentalt tryck vid vändningen'],
    clubs: ['D', 'H'],
    strategy: 'safe',
    note: 'Index 1 kräver respekt. Driver + Hybrid för maximal längd, men spela säkert. Bogey är ett mycket bra resultat här — försök inte vara hjälte. Avsluta niorna med ett lugnt huvud.',
  },
  {
    n: 10, par: 5, meters: 440, index: 12,
    title: 'Lång start på back nine',
    desc: 'Lång par 5 som öppnar back nine. Tre solida slag krävs — driver för maximal längd, hybrid som mellanklubb och wedge in till green.',
    risks: ['Längd', 'Trötthet efter vändningen', 'Index 12'],
    clubs: ['D', 'H', '56'],
    strategy: 'balanced',
    note: 'Par 5 på 440m — helt klart driverhål. Ta ett slag i taget: bra drive, bra hybrid, och avsluta med wedge. Par är ett bra resultat, birdie är möjligt.',
  },
  {
    n: 11, par: 5, meters: 453, index: 14,
    title: 'Banans längsta hål',
    desc: 'Längsta hålet på banan. Index 14 betyder att det inte är det svåraste trots längden — men tre bra slag krävs. Driver, hybrid och wedge in.',
    risks: ['Längd', 'Felplacering kan ge svårt tredjeskott'],
    clubs: ['D', 'H', '56'],
    strategy: 'balanced',
    note: '453m par 5 — full verktygslåda. Driver för att komma i position, hybrid för att komma nära, 56:an för att avsluta. Index 14 ger dig en extra slag i handicap — utnyttja det.',
  },
  {
    n: 12, par: 4, meters: 324, index: 4,
    title: 'Det tredje svåraste',
    desc: 'Index 4 — ett av banans riktigt tuffa hål. Medellångt par 4 där precision väger tyngre än längd. Grönkomplex och hinder straffar misstag.',
    risks: ['Index 4', 'Kräver exakt inspel', 'Svår green'],
    clubs: ['D', '6'],
    strategy: 'balanced',
    note: 'Trots att det är under 325m är detta hålet en utmaning. Säkra driver i fairway, använd järn 6 för kontrollerat inspel. Bogey är inte ett misslyckande här.',
  },
  {
    n: 13, par: 4, meters: 322, index: 8,
    title: 'Mellanhålet',
    desc: 'Medellångt par 4 med index 8 — mitt i spannet på svårighetsskalan. Kräver ett bra andreskott för att hålla sig på rätt sida av greenen.',
    risks: ['Greenkomplex', 'Sidohinder'],
    clubs: ['D', '6'],
    strategy: 'balanced',
    note: 'D + 6 är en solid plan för 322m. Spela för par och lämna enkla puttar. Inget hjältekamp behövs.',
  },
  {
    n: 14, par: 4, meters: 329, index: 6,
    title: 'Det femte svåraste',
    desc: 'Index 6 placerar detta hål bland de tuffare på banan. Längre par 4 som kräver bra drive och exakt inspel.',
    risks: ['Index 6', 'Längd', 'Kräver precision'],
    clubs: ['D', '6'],
    strategy: 'balanced',
    note: 'Inga gratispar här — index 6 är ett tufft hål. Driver för att komma i position, järn 6 in. Bogey är ett hederligt resultat, par är bra jobbat.',
  },
  {
    n: 15, par: 3, meters: 140, index: 18,
    title: 'Andningspausen',
    desc: 'Banans lättaste hål! Index 18 och bara 140m — detta är birdie-chansen på back nine. Kort par 3 med enkel greentillgång.',
    risks: ['Falsk trygghet kan leda till slarvigt slag'],
    clubs: ['9'],
    strategy: 'aggressive',
    note: 'Index 18 = banans lättaste hål. Järn 9 på 140m är rätt klubba. Sikta på flaggan — detta är hålet där du ska sänka puttet och ta hem birdien.',
  },
  {
    n: 16, par: 4, meters: 363, index: 2,
    title: 'Banans näst svåraste',
    desc: 'Index 2 — näst svåraste hålet på hela banan. Långt par 4 på 363m som kräver bra drive och ett säkert inspel. Fokus och tålamod.',
    risks: ['Index 2', 'Längd', 'Trötthet i finalen', 'Hinder längs banan'],
    clubs: ['D', 'H'],
    strategy: 'safe',
    note: 'Index 2 kräver respekt. Driver för maximal längd, hybrid för säkert inspel mot green. Spela för par — bogey är acceptabelt. Tappa inte humöret om det inte går vägen.',
  },
  {
    n: 17, par: 3, meters: 103, index: 16,
    title: 'Näst sista hålet',
    desc: 'Kort par 3 på bara 103m. Index 16 visar att det inte är svårt — men fokuset måste vara kvar inför avslutningen.',
    risks: ['Överskjutning av green', 'Mentalt tryck inför 18:e'],
    clubs: ['56'],
    strategy: 'safe',
    note: '103m är wedge-avstånd. 56-gradersjärn eller liknande, sikta mitt på green. Spara energin och fokuset till 18:e — ta bara paret här.',
  },
  {
    n: 18, par: 4, meters: 274, index: 10,
    title: 'Klubbhushålet',
    desc: 'Avslutande par 4 på 274m med index 10. Hybrid från tee ger säker placering, järn 9 in. Klubbhuset väntar — avsluta starkt.',
    risks: ['Klubbhus-press', 'Bunkrar runt green'],
    clubs: ['H', '9'],
    strategy: 'safe',
    note: 'Klokt val att ta hybrid istället för driver — kort par 4 kräver kontroll, inte längd. Järn 9 in och avsluta med ett bra putt. Birdie här lyfter hela rundan.',
  },
];
